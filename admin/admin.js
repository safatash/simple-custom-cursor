( function () {
    ...
    /* ══════════════════════════════════════════
       TAB NAVIGATION
    ══════════════════════════════════════════ */
    var navBtns = document.querySelectorAll( '.scc-nav-btn' );
    var tabs    = document.querySelectorAll( '.scc-tab' );
    ...
    navBtns.forEach( function ( btn ) {
        btn.addEventListener( 'click', function () {
            ...
            var panel = document.getElementById( 'scc-tab-' + target );
    ...
    /* ══════════════════════════════════════════
       CURSOR TYPE CARDS
    ══════════════════════════════════════════ */
    var typeCards = document.querySelectorAll( '.scc-type-card' );
    ...
    function initSlider( rangeEl ) {
        ...
        function update() {
            ...
            rangeEl.style.setProperty( '--scc-fill', pct + '%' );
    ...
    document.querySelectorAll( '.scc-range-visible' ).forEach( initSlider );

    /* ══════════════════════════════════════════
       COLOR PICKERS — swatch + hex sync
    ══════════════════════════════════════════ */
    document.querySelectorAll( '.scc-color-swatch' ).forEach( function ( swatch ) {
        var picker    = swatch.querySelector( 'input[type="color"]' );
        var dot       = swatch.querySelector( '.scc-color-dot' );
    ...
    /* ══════════════════════════════════════════
       LIVE PREVIEW
    ══════════════════════════════════════════ */
    var stage      = document.getElementById( 'scc-preview-stage' );
    var prevDot    = document.getElementById( 'scc-prev-dot' );
    var prevOutline= document.getElementById( 'scc-prev-outline' );
    var prevCH     = document.getElementById( 'scc-prev-ch' );
    var prevCV     = document.getElementById( 'scc-prev-cv' );
    ...
    function getSettings() {
        // Cursor type
        var typeCard = document.querySelector( '.scc-type-card.active' );
        ...
        var dotColorEl     = document.getElementById( 'scc_dot_color_hex' );
        var outlineColorEl = document.getElementById( 'scc_outline_color_hex' );
        var dotColor     = dotColorEl     ? dotColorEl.value     : '#ffffff';
        var outlineColor = outlineColorEl ? outlineColorEl.value : '#ffffff';

        // Sizes
        var dotSizeEl      = document.querySelector( 'input[name="scc_options[dot_size]"]' );
        var outlineSizeEl  = document.querySelector( 'input[name="scc_options[outline_size]"]' );
        var outlineWtEl    = document.querySelector( 'input[name="scc_options[outline_weight]"]' );
        ...
        // Blend
        var blendEl  = document.querySelector( 'select[name="scc_options[blend_mode]"]' );
        var blend    = blendEl ? blendEl.value : 'difference';

        // Lag speed
        var lagEl    = document.querySelector( 'input[name="scc_options[lag_speed]"]' );
    ...
    var blendSelect = document.querySelector( 'select[name="scc_options[blend_mode]"]' );
