( function () {
    ...
    if ( mobileForce ) {
        document.body.classList.add( 'scc-force-custom' );
    }
    ...
    switch ( type ) {
        ...
        case 'circle-only':
            outline = makeEl( 'scc-outline' );
            break;

        case 'crosshair':
            crossH = makeEl( 'scc-crosshair-h' );
            crossV = makeEl( 'scc-crosshair-v' );
            break;

        case 'ring-fill':
            dot     = makeEl( 'scc-dot' );
            outline = makeEl( 'scc-outline scc-ring-fill' );
            break;
